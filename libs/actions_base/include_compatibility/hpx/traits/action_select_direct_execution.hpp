...
#if defined(HPX_MSVC)
#pragma message(                                                               \
    "The header hpx/traits/action_select_direct_execution.hpp is deprecated, \
    please include hpx/actions_base/traits/action_select_direct_execution.hpp instead")
#else
#warning                                                                       \
    "The header hpx/traits/action_select_direct_execution.hpp is deprecated, \
    please include hpx/actions_base/traits/action_select_direct_execution.hpp instead"
